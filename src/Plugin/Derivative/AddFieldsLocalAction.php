...
namespace Drupal\add_fields\Plugin\Derivative;
 ...
 */
class AddFieldsLocalAction extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    foreach ($this->entityTypeManager->getDefinitions() as $entity_type_id => $entity_type) {
      if ($base_route = $entity_type->get('field_ui_base_route')) {
        $this->derivatives["field_storage_config_add_fields_$entity_type_id"] = [
          'route_name' => "add_fields.field_storage_config_add_$entity_type_id",
